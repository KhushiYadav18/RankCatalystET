"""
Django settings for RankCatalyst project.
"""
...
# config.py is in backend/ (same level as config/)
# Use importlib to avoid conflicts with the config directory
...
ALLOWED_HOSTS = config_module.ALLOWED_HOSTS
...
# CORS Settings
CORS_ALLOW_ALL_ORIGINS = config_module.CORS_ALLOW_ALL_ORIGINS
...
OPENROUTER_MODEL = config_module.OPENROUTER_MODEL
OPENROUTER_SITE_URL = config_module.SITE_URL
OPENROUTER_SITE_NAME = config_module.SITE_NAME
